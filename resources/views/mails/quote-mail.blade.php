...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>360 Facility Services Quotation</title>
    <!-- 
  ...
  <body>
    <span class="preheader">Thanks for considering us. Your quote is attached</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td class="email-masthead">
                <a href="http://360degreesfs.com.au" class="email-masthead_name">
                    <img src="https://360degreesfs.com.au/wp-content/uploads/2019/06/cropped-111.png" width="100px;">
                </a>
              </td>
            </tr>
            <!-- Email Body -->
                          ...
                          <td colspan="2">
                            <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                              <tr>
								...
								<th class="purchase_heading">
                                  <p class="align-right">Sub Total</p>
                                </th>
                              </tr>
                            <?php 
                                $items = $quote['items'];
                            ...
                            <?php } ?>
                                ...
                                <td width="20%" class="purchase_footer" valign="middle">
                                  <p class="purchase_total"><?php echo $quote['tax']; ?></p>
							                ...
							                <tr>
                                <td colspan="4" width="20%" class="purchase_footer" valign="middle">
                                  <p class="purchase_total purchase_total--label">Net Total ($)</p>
                                </td>
                                <td width="20%" class="purchase_footer" valign="middle">
                                  <p class="purchase_total"><?php echo $quote['total']; ?></p>
                                </td>
                              </tr>
